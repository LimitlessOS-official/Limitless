...
/* Dummy graphics functions */
void initialize_graphics_system(void* framebuffer_addr, int width, int height, int pitch, int bpp) {
...
void display_system_info(const char* info) {
    // Dummy implementation
}

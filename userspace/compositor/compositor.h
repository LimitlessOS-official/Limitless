...
void compositor_draw_gradient(surface_t* surface, gui_rect_t* rect, color_t start, color_t end, bool vertical);
...
bool rect_intersects(gui_rect_t* r1, gui_rect_t* r2);
void rect_clip(gui_rect_t* rect, gui_rect_t* bounds);

            ...
            case 8:
                ...
                if (fgets(input, sizeof(input), stdin)) {
                    ...
                    if (strcmp(input, "all") == 0) {
                        ...
                        if (reset_all_settings() == 0) {
                            printf("✓ All settings have been reset to defaults\n");
                        } else {
                            printf("✗ Failed to reset settings\n");
                        }
                    } else {
                        printf("Resetting %s settings...\n", input);
                        if (reset_category_settings(input) == 0) {
                            printf("✓ %s settings have been reset to defaults\n", input);
                        } else {
                            printf("✗ Failed to reset %s settings\n", input);
                        }
                    }
                }
                break;
